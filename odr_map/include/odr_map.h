...
#include "odr_map_msgs/MapLane.h"
#include "odr_map_msgs/MapBoundary.h"
#include "odr_map_msgs/MapTrafficLight.h"
#include "odr_map_msgs/MapCrosswalk.h"
#include "odr_map_msgs/MapStopLine.h"
#include "odr_map_msgs/LaneInformation.h"
#include "odr_map_msgs/MapObject.h"
#include "odr_map_msgs/BoundaryPolygons.h"
...
using MapBasePathVector = std::vector<odr_map_msgs::MapBasepath>;
using MapLaneVector = std::vector<odr_map_msgs::MapLane>;
...
public:
    ...
    std::vector<odr_map_msgs::MapBoundary> GetMapBoundaries(const Road& road, double step);

    const odr_map_msgs::MapObject &GetAllMapObjects() const;

    odr_map_msgs::MapObject GetMapObject(float x, float y, float z, double distance);

    template <typename Sequence>
    odr_map_msgs::MapObject GetMapObjectWithinTargetRoads(const Sequence& road_ids) const;
    ...
    void AddPolygonsWithinTargetRoads(const std::vector<RoadId>& road_ids,
                                      odr_map_msgs::BoundaryPolygons& boundaryPolygons,
                                      odr_map_msgs::BoundaryPolygons& sidewalkPolygons,
                                      odr_map_msgs::BoundaryPolygons& crosswalkPolygons);
...
private:
    ...
    void ReverseDirection(odr_map_msgs::MapLane& mapLane);
    void AddPathConnection(std::vector<odr_map_msgs::MapBasepath> path_connection_list);
private:
    boost::optional<carla::road::Map> _map;
    carla::SharedPtr<carla::client::Map> _client_map;
    odr_map_msgs::MapObject _mapObject_all;
