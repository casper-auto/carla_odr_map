...
private:
  ...
  // map objects
  std::vector<odr_map_msgs::MapBasepath> map_basepaths_;
  std::vector<odr_map_msgs::MapLane> map_lane_boundaries_;
  std::vector<odr_map_msgs::MapBoundary> map_road_boundaries_;
};
...
void OdrMapLoader::initalize() {
  ...
  // Get All Map Info
  //////////////////////////////////////////////////////////////////////////
  odr_map_msgs::MapObject map_obj = map_parser_->GetAllMapObjects();
  ...
  for(int i = 0; i < map_basepaths_.size(); i++) {
    odr_map_msgs::MapBasepath basepath = map_basepaths_[i];
  ...
  for(int i = 0; i < map_lane_boundaries_.size(); i++) {
    odr_map_msgs::MapLane map_lane = map_lane_boundaries_[i];
    std::vector<odr_map_msgs::LaneInformation> lane_info_array = map_lane.lane_information;
  ...
  for(int i = 0; i < map_road_boundaries_.size(); i++) {
    odr_map_msgs::MapBoundary boundary = map_road_boundaries_[i];
